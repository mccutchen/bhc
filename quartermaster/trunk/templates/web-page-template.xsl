                        ...
                        <td id="page-container" valign="top">
                            <div id="page-header">
                                ...
                                <xsl:if test="current()//course[@financial_aid] or current()/self::schedule">
                                    <p class="financial-aid">Look for courses eligible for <a href="http://www.dcccd.edu/Continuing+Education/Paying+for+College/Financial+Aid/" target="_blank">Financial Aid</a> highlighted in green.</p>
                                </xsl:if>
                            </div>
