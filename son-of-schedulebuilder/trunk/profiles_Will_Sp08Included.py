...
class BaseProfile:
    ...
    duplicate_names = ['Anderson', 'Campbell', 'Collins', 'Elliott', 'Garcia', 'Hammond', 'Jackson', 'Johnson', 'Jones', 'Martin', 'Maxey', 'Miller', 'Moore', 'Neal', 'Robinson', 'Scott', 'Sims', 'Taylor', 'Thompson', 'Thornton', 'Weaver', 'Wood']
...
class Enrolling(Enrolling, Summer, Web):
	input = ('data/2007-fall/BH2007FA.TXT', 'data/2007-summer/BH2007S1.TXT', 'data/2007-summer/BH2007S2.TXT')
	output_dir = 'enrolling'
