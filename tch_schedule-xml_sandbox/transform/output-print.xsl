<xsl:stylesheet
	...
	<xsl:template match="term">
		...
		<xsl:apply-templates select="descendant::subject[descendant::class[@is-suppressed = 'false']]" mode="init">
		...
		<xsl:call-template name="init-special-section">
			...
			<xsl:with-param name="classes" select="descendant::class[@is-suppressed = 'false' and @is-dl = 'true']" tunnel="yes" />
		</xsl:call-template>
		<!-- flex term -->
		<xsl:call-template name="init-special-section">
			<xsl:with-param name="path" select="$path" />
			<xsl:with-param name="title" select="'Flex Term'" tunnel="yes" />
			<xsl:with-param name="classes" select="descendant::class[@is-suppressed = 'false' and @is-flex = 'true']" tunnel="yes" />
		</xsl:call-template>
		<!-- weekend -->
		<xsl:call-template name="init-special-section">
			<xsl:with-param name="path" select="$path" />
			<xsl:with-param name="title" select="'Weekend'" tunnel="yes" />
			<xsl:with-param name="classes" select="descendant::class[@is-suppressed = 'false' and @is-w = 'true']" tunnel="yes" />
		</xsl:call-template>
		<!-- weekend core curriculum -->
		<xsl:call-template name="init-special-section">
			<xsl:with-param name="path" select="$path" />
			<xsl:with-param name="title" select="'Weekend Core Curriculum'" tunnel="yes" />
			<xsl:with-param name="classes" select="descendant::class[@is-suppressed = 'false' and @is-wcc = 'true']" tunnel="yes" />
		</xsl:call-template>
	</xsl:template>
	...
	<xsl:template match="term" mode="output">
		...
		<xsl:apply-templates select="division[@name = 'School of the Arts']/subject[descendant::class/@is-suppressed = 'false']">
            <xsl:sort select="@name" />
        </xsl:apply-templates>
		...
		<xsl:apply-templates select="division[@name = 'Senior Adult Education Office']/subject[descendant::class/@is-suppressed = 'false']">
            <xsl:sort select="@name" />
        </xsl:apply-templates>
    </xsl:template>
	...
	<xsl:template match="subject">
		...
		<xsl:apply-templates select="type[descendant::class/@is-suppressed = 'false']">
            <xsl:sort select="@sortkey" data-type="number" />
        </xsl:apply-templates>

		<xsl:apply-templates select="topic[descendant::class/@is-suppressed = 'false']">
            <xsl:sort select="@sortkey" data-type="number" />
            <xsl:sort select="@name" />
        </xsl:apply-templates>
	...
	<xsl:template match="topic">
		...
		<xsl:apply-templates select="subtopic[descendant::class/@is-suppressed = 'false']">
            <xsl:sort select="@sortkey" data-type="number" />
            <xsl:sort select="@name" />
        </xsl:apply-templates>
	...
	<xsl:template match="type">
		...
		<xsl:apply-templates select="course[descendant::class/@is-suppressed = 'false']">
			<xsl:sort select="@sortkey" data-type="number" />
	...
	<xsl:template match="course">
		...
		<xsl:apply-templates select="class[@is-suppressed = 'false']">
			<xsl:sort select="@sortkey" data-type="number" />
